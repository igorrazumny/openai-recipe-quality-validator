...
def display_controls():
    ...
    You are an expert QA auditor for pharmaceutical manufacturing recipes.
    Evaluate the following JSON record for any deviations or inconsistencies.
    If you detect a problem, classify the deviation type and severity.
    Otherwise, confirm it is correct.
    """)
...
# )
    ...
    return uploaded_file, num_entries, model, prompt
